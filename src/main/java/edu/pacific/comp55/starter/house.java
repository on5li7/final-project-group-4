...
public class house {
	...
	//sets the time of the house
		...
		public house() {
			...
			this.GreenHouse = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.TheStudy = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Armory = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 3);
			this.Workshop = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Dungeon = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Outdoors_1 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Outdoors_2 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Outdoors_3 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 5);
			this.Outdoors_4 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
		    this.Bedroom_1 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Bedroom_2 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Bedroom_3 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Bedroom_4 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Bedroom_5 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Bedroom_6 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Bedroom_7 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Bedroom_8 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Bedroom_9 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.Bedroom_10 = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
			this.TheCliff = new Room(new ArrayList<item>(), this, isDark, new ArrayList<Convos>(), null, new ArrayList<Room>(), new HashSet<Partygoer>(), 0);
