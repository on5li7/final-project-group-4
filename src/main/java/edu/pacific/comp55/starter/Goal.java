...
public enum Goal {
		...
		GET_FRAGRANT_PLANT_OUTDOORS, GET_RITUAL_ITEM,
		...
		LOOSEN_CHANDELIER, CLIFF_STALKER, MAKE_BOMB, LOOSEN_BALCONY, BALCONY_STALKER, GET_WRENCH, GET_SCREWDRIVER, GET_HAMMER,		
